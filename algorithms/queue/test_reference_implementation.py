...
from algorithms.queue import reference_implementation
...
class QueueTest(unittest.TestCase):
    ...
    def test_api(self):
        data_structure = reference_implementation.Queue()
    ...
    def test5(self):
        ...
        data_structure = reference_implementation.Queue(sample_data)
